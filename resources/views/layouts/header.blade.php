    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <button type="submit" class="nav-link btn btn-link text-danger"
                ...
                <p style="margin-top: 5px; font-size: 13px; font-family:JetBrains Mono">Sair</p>
            </button>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="dashboard">
                        ...
                        <span class="nav-link-title">Pagina Inicial</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('feed.index') }}">
                        ...
                        <span class="nav-link-title">Vagas Disponíveis</span>
                    </a>
                </li>

...
<div class="container py-4">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">
                        Publicado por {{ $jobPost->empregador->user->name }} em {{ $jobPost->created_at->format('d/m/Y H:i') }}
                    </small>
                </div>
                <div>
            ...
            <!-- Conteúdo Resumido -->
            <p class="mt-3">{{ $jobPost->descricao }}</p>
        ...
        <div class="card-footer bg-light">
            ...
            <form action="{{ route('feed.comentar', $jobPost->id) }}" method="POST">
                ...
                <div class="d-flex align-items-center">
                    <img src="{{ auth()->user()->avatar ?? asset('img/user-placeholder.png') }}" 
                         alt="User Avatar" class="rounded-circle me-2" width="40">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><strong>Nome:</strong> {{ $jobPost->empregador->user->name }}</p>
                        <p><strong>Email:</strong> {{ $jobPost->empregador->user->email }}</p>
                        <p><strong>Empresa:</strong> {{ $jobPost->empregador->empresa }}</p>
